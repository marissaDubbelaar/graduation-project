					...
					$("#dashboard").show();
						...
						$.each(data, function(i, content){
							$.each(attr, function(t, types){
								// The 1st position when performing item % 3 and is used to obtain the cell type name.
								if (t % 3 === 1 && t !== 0) {
									...
									// Found on the 2th position when performing item % 3.
									tpmFreqData["TPM Low"] = data[i][attr[t]["name"]]
								} else if (t % 3 === 0 && t !== 0) {
									// Found on the 0th position when performing item % 3.
